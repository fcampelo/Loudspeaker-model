...
\item Enter the correct path in lines 33-35 of file \textit{loudspeaker.lua}.
\item Enter the correct path in 5-8 of \textit{CallFEMM\_LS.m}.
\end{itemize}
\end{enumerate}
...
$>>$ Y = CallFEMM\_LS(X)
\item If \textit{CallFEMM\_LS.m} is correct, Matlab will open a FEMM window, which will run the simuation and close automatically.\\
\end{itemize}
\end{enumerate}
...
Questions, comments and suggestions can be filed to \url, or sent directly to \url{fcampelo@ufmg.br}.\\
